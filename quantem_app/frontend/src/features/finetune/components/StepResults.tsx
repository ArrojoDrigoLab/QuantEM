/**
 * Step 5 — what the adaptation actually bought.
 *
...
import {
  ...
  OracleCeiling,
  SplitModeNote,
} from "@/features/finetune/components/HonestScore";
import { SweepCurve } from "@/features/finetune/components/SweepCurve";
import { GroundTruthProvenancePanel } from "@/features/finetune/components/GroundTruthProvenance";
import type { GroundTruthProvenance } from "@/features/finetune/groundTruthProvenance";
