...
describe("AboutTheNumbers", () => {
  it("badges the crops the threshold was fitted on (honesty rule 2)", () => {
    render(<AboutTheNumbers adapter={makeAdapter()} baseSweep={null} {...NO_PROVENANCE} />);
  ...
  it("says so when the saved head was never re-scored", () => {
    render(
      <AboutTheNumbers adapter={makeAdapter({ verified_reload: false })} baseSweep={null} {...NO_PROVENANCE} />
    );
