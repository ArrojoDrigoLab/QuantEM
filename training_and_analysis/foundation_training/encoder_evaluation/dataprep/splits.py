"""Read the Group-1 split CSVs and resolve every crop to its EM + label paths and manifest entry.
...
def load_split_rows(corpus_root: str | Path, organelle: str) -> list[CropRow]:
    """Parse ``<corpus_root>/splits/group1_<organelle>.csv`` into CropRow records."""
